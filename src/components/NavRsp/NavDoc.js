        ...
        <Hidden smDown>
          ...
          <ul className={classes.navLinks}>
            <li className={classes.link}>
              <a className='link' href="/private/curso">Cursos</a>
            </li>
            <li className={classes.link}>
              <a className='link' href="/private/materiales">Materiales</a>
            </li>
           {/*  <li className={classes.link}>
              <a className='link' href="/colegiosfelices">Colegios CreSer</a>
            </li> */}
            <li className={classes.link}>
              <a className='link' href="/Aulas">Aulas</a>
            </li>
            {/* <li className={classes.link}>
              <a className='link' href="/eventos">Eventos</a>
            </li> */}
            <li className={classes.link}>
              <a className='link' href="/contact">Anuncios</a>
            </li>
            {!isAuthenticated && (
             ...
             {isAuthenticated && (
                <button className={classes.loginButton}>
                <a className='linklog' href="/private/profile">{user_data.nombre}</a>
              </button>
              )}
            {isAuthenticated && (
